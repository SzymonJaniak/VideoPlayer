...
public class Film2 implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        String mediaPath = Paths.get("src/main/resources/com/example/odtwarzaczfilmowy/videos/video2.mp4").toUri().toString();
